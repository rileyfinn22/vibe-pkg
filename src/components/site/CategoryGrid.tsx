      ...
      {list.map((c) => (
        ...
        >
          <img
            src={c.image}
            alt={c.title}
            className="absolute inset-0 h-full w-full object-cover opacity-100 dark:opacity-65 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 brightness-[2] contrast-[1.15]"
          />
